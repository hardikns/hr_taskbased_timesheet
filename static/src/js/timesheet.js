openerp.hr_taskbased_timesheet = function(instance) { 
        ...
        init_add_account: function() {
            ...
            self.$(".oe_timesheet_weekly_add_row button").click(function() {
                ...
                if (id === false || task_id === false) {
                    ...
                    instance.webclient.notification.warn(_t("Validation"), _t("Fields indicated are mandatory"));
                    return;
                }
